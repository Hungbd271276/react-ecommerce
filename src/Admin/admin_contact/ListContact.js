            ...
            <tbody>
                {
                    props.contacts.map((contact, index) => (
                        ...
                        <tr key={contact._id}>
                            ...
                            <td>{contact.text}</td>
                            <td>
                                <Link to={`/admin/product/${contact._id}`} href="#" className="btn btn-primary bg-primary">
                            ...
                            <td>
                                <a className="svg btn  btn-danger bg-danger btn-remove" style={{ color: '#fff' }} onClick={() => props.onDeleteContact(contact._id)}>
