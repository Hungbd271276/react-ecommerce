...
const ClothesProduct = (props) => {
    const { data } = props;
    return (
        <div className="row mx-auto container-fluid" >
            {
                data.filter(product => product.category == '6065cffec19ef6710ca07a40').slice(0, 4).map(products => {
                    return (
                        <div className="product text-center col-lg-3 col-md-4 col-6" key={products._id} >
